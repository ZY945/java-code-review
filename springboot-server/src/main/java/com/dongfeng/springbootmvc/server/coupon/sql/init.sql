...
GRANT ALL PRIVILEGES ON coupon_db.* TO 'root'@'localhost';
FLUSH PRIVILEGES;
...
INSERT INTO c_coupon_template (
    name, description, type, discount, threshold, 
    total, remaining, start_time, end_time, status
) VALUES (
    '满100减50', '双11优惠券', 1, 50.00, 100.00,
